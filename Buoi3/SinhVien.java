...
public class SinhVien {
	...
	public float diemTB() {
		float diemTB = 0.0f;
		for(int i=0;i<soHP;i++) {
			if(diemHP[i].equals("A")) diemTB+=4;
			else if(diemHP[i].equals("B+")) diemTB+= 3.5;
			else if(diemHP[i].equals("B")) diemTB += 3;
			else if(diemHP[i].equals("C+")) diemTB+= 2.5;
			else if(diemHP[i].equals("C")) diemTB+= 2;
			else if(diemHP[i].equals("D+")) diemTB+= 1.5;
			else if(diemHP[i].equals("D")) diemTB+= 1;
		}
		return diemTB/soHP;
	}
	public String MSSV() {
